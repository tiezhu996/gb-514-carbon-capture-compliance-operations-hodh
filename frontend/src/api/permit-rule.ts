...
import type { DomainRecord, RuleRetireCheck } from '../types/domain';
...
export async function checkPermitRuleRetire(id: number) {
  return request<RuleRetireCheck>(`/rules/${id}/retire-check`);
}
